...
def CATEGORIES():
	...
	addDir('Desporto Internacional','https://dl.dropboxusercontent.com/s/6kg6fsemrj80mqh/Desporto2.txt?dl=0',2,os.path.join(artfolder,'2.png'))
	addDir('Generalistas','https://dl.dropboxusercontent.com/s/jsb4aj3m3vk3n52/Generalistas.txt?dl=0',2,os.path.join(artfolder,'3.png'))
	addDir('Notícias','https://dl.dropboxusercontent.com/s/67wkgntatx5bo46/Noticias.txt?dl=0',2,os.path.join(artfolder,'4.png'))
	addDir('Filmes','https://dl.dropboxusercontent.com/s/tpgw39jbyim6bk8/Filmes.txt?dl=0',2,os.path.join(artfolder,'5.png'))
	addDir('Musica','https://dl.dropboxusercontent.com/s/qy59cd214cti771/Musica.txt?dl=0',2,os.path.join(artfolder,'6.png'))
